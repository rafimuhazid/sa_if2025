...
export default function LoginPage() {
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden flex items-center justify-center font-sans bg-[#080808]">
      ...
      >
        ...
        <button 
          onClick={() => router.push('/')}
          className="absolute left-8 top-10 text-[#A3FF12] hover:scale-110 transition-transform cursor-pointer"
        >
        ...
        <form className="w-full space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-white text-sm font-bold tracking-widest ml-1 uppercase opacity-80">
              NPM
            </label>
            <input 
              type="text"
