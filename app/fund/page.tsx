...
import { faArrowLeft, faDollarSign, faArrowTrendDown, faArrowTrendUp } from '@fortawesome/free-solid-svg-icons';
...
export default function FundPage() {
  ...
  const TransactionCard = ({ division, date, amount }: any) => (
    <div className="p-5 rounded-[1.5rem] border-2 flex justify-between items-center bg-black/20 mb-4" style={{ borderColor: lime }}>
      <div>
  ...
  return (
    <main className={`${spaceGrotesk.className} relative min-h-screen text-white pb-32 overflow-hidden`}>
      ...
      <div className="relative z-10 p-6 space-y-8">
        ...
        <div className="p-6 rounded-[2rem] border-2 bg-black/40 backdrop-blur-sm" style={{ borderColor: lime, boxShadow: `0 0 20px rgba(163,255,18,0.2)` }}>
          <div className="flex items-center gap-5 mb-5">
            ...
            <div>
              ...
              <h2 style={{ color: lime }} className="font-black text-3xl italic tracking-tight">
                Rp. 4.500.000
              </h2>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          {/* DIVISI */}
          <TransactionCard division="KPK" date="MARCH 10, 2026" amount="Rp.1.200.000" />

          <TransactionCard division="P3K" date="MARCH 12, 2026" amount="Rp.850.000" />

          <TransactionCard division="PDD" date="MARCH 15, 2026" amount="Rp.1.150.000" />
        </div>
      </div>
