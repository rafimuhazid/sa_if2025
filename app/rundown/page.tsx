...
export default function RundownPage() {
  ...
  const Card = ({ title, time, duration, location, status }: any) => (
    ...
    >
      ...
      <div className="flex-1 pt-1">
        <p className="text-[15px] font-black mb-3 leading-tight italic" style={{ color: lime }}>
          {title}
        </p>
  ...
  return (
    <main className={`${spaceGrotesk.className} relative min-h-screen text-white pb-28 overflow-hidden`}>
      {/* BACKGROUND IMAGE */}
      <div
      ...
      <div className="relative z-10 px-6 pt-6 font-sans">
        <Card title="OPENING CEREMONY" time="09:00 AM" duration="30 MIN" location="MAIN AUDITORIUM" />

        <Card title="KEYNOTE: FUTURE OF TECH" time="09:30 AM" duration="60 MIN" location="MAIN AUDITORIUM" />

        <Card title="WORKSHOP: WEB DEVELOPMENT" time="11:00 AM" duration="90 MIN" location="ROOM A-101" status="LIVE" />

        <Card title="ISHOMA" time="12:30 AM" duration="90 MIN" location="ROOM A-101" status="UPCOMING" />
      </div>
