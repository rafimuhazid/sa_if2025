...
export default function LandingPage() {
  ...
  return (
    <main
      ...
      style={{ backgroundColor: greenBase }}
    >
      {/* BASE BACKGROUND */}
      <div
      ...
      <motion.div
        ...
        style={{
          ...
          backgroundImage:
            phase >= 4 ? "url('/img/bg-texture.jpeg')" : "none",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <motion.div
          animate={{ y: phase >= 5 ? -50 : 0 }}
          transition={{ duration: 1 }}
          className="flex flex-col-reverse items-center z-30"
        >
          {/* TEXT */}
          <div className="flex flex-col items-center text-center mt-4">
            ...
            >
              ...
              <p
                className="text-[10px] font-bold tracking-[0.2em] opacity-60 uppercase"
                ...
                >
                  <motion.button
                    ...
                    style={{
                      ...
                      boxShadow:
                        "0 8px 25px -5px rgba(180, 227, 75, 0.5)",
                    }}
                  >
                    LOGIN
                  </motion.button>
          ...
          >
            <img
              src="/img/logo.png"
              className="w-32 h-32 drop-shadow-[0_0_20px_rgba(180,227,75,0.4)]"
              alt="Logo"
            />
          </motion.div>
        </motion.div>
